...
|----------|-------|-------------|
| [**messaging**]({{ site.baseurl }}/docs/types/messaging/) | 2 types | Email spam and bulk messaging abuse |
| [**connection**]({{ site.baseurl }}/docs/types/connection/) | 8 types | Network attacks including DDoS, port scans, and login attacks |
| [**content**]({{ site.baseurl }}/docs/types/content/) | 9 types | Malicious web content including phishing, malware, and fraud |
...
| [**infrastructure**]({{ site.baseurl }}/docs/types/infrastructure/) | 2 types | Compromised systems and botnets |
