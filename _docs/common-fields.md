...
| `reporter` | object | 🟠 Mandatory | Organization that identified the abuse (complainant) |
| `sender` | object | 🟠 Mandatory | Organization transmitting the report |
...
How this report was generated by the reporter.
